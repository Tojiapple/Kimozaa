...
$sql = "SELECT a.article_id, a.title, a.summary, a.created, a.category_id, a.member_id, a.published,
               c.name     AS category,
         ...
         ORDER BY a.article_id DESC;";                         // SQL to get article summaries
  ...
  <main class="container" id="content">
    ...
    <table>
      ...
      <tr>
        ...
        <td><a href="article.php?id=<?= $article['article_id'] ?>" class="btn btn-primary">Edit</a></td>
        <td><a href="article-delete.php?id=<?= $article['article_id'] ?>" class="btn btn-danger">Delete</a></td>
      </tr>
      <?php } ?>
    </table>
  </main>
